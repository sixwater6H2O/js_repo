...
const music = new Audio('https://sixwater6h2o.github.io/img/img/star.mp3');
...
function catchUpState() {
    ...
    if (walk.current == 0) {
        ...
        document.getElementById("pet").src = "https://sixwater6h2o.github.io/img/img/眨眼.gif"
...
function attackState() {
    ...
    if (attack.current == 0) {
		...
		//SpecialEnd();
		SpecialSay(playing_talk);
        document.getElementById("pet").src = "https://sixwater6h2o.github.io/img/img/弹琴.gif"
